...
public class nissanjuke {
    ...
    public void arabamAppTest() throws InterruptedException {
        ...
        action.press(PointOption.point(508,1538)) // press kismi ekranda tiklama kaydirma islemi icin tiklama yapacagimiz ilk nokta
                .waitAction(WaitOptions.waitOptions(Duration.ofMillis(95))) // baslangic noktasi ile bitis noktasi arasindaki gecen sure
        ...
        driver.findElementByXPath("//*[@text='Nissan']").click();
        // 1.4 TSI BlueMotion secilir
        driver.findElementByXPath("//*[@text='GT-R']").click();
        // Paket secimi yapilir
        driver.findElementByXPath("//*[@text='Black Edition']").click();
        Thread.sleep(750);
